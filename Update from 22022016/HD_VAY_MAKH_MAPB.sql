...
/****** Object:  StoredProcedure [dbo].[HD_VAY_MAKH_MAPB]    Script Date: 02/26/2016 15:17:39 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[HD_VAY_MAKH_MAPB] 
...
WHERE [dbo].[TD.HOP_DONG].MA_KH_VAY = [dbo].[TD.KH_VAY].MA_KH_VAY 
      AND [dbo].[TD.HOP_DONG].[MA_KH_VAY]=@ma_kh_vay 
