...
/****** Object:  StoredProcedure [dbo].[HD_VAY_CMT_TC_MAPB]    Script Date: 02/26/2016 15:18:49 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[HD_VAY_CMT_TC_MAPB] 
...
WHERE [dbo].[TD.HOP_DONG].MA_KH_VAY = [dbo].[TD.KH_VAY].MA_KH_VAY 
      AND [dbo].[TD.KH_VAY].[TC_CMND_DAI_DIEN]=@cmnd 
